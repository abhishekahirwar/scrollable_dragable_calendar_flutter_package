...
import 'package:scrollable_dragable_calendar/scrollable_dragable_calendar.dart';
import 'package:scrollable_positioned_list/scrollable_positioned_list.dart';

typedef OnDateSelected = void Function(DateTime);

class ScrollableDragableCalendar extends StatefulWidget {
  ...
  @override
  State<ScrollableDragableCalendar> createState() =>
      _ScrollableDragableCalendarState();
}

class _ScrollableDragableCalendarState
    extends State<ScrollableDragableCalendar> {
  ...
  @override
  void didUpdateWidget(ScrollableDragableCalendar oldWidget) {
  ...
  void _selectedDayIndex() {
    ...
    // Abhi
    if (_daySelectedIndex != null && _days.isNotEmpty) {
      _scrollAlignment = 1.1 - (_daySelectedIndex! / _days.length);
    }
  }
  ...
  Widget _buildYearList() {
    return SizedBox(
      ...
      child: ScrollablePositionedList.builder(
        ...
        padding: EdgeInsets.only(left: widget.leftMargin), // Abhi
    ...
    return SizedBox(
      ...
      child: ScrollablePositionedList.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          ...
          final monthName = DateFormat.MMM(_locale).format(currentDate); // Abhi
  ...
  Widget _buildDayList() {
    return SizedBox(
      ...
      child: ScrollablePositionedList.builder(
        ...
        initialAlignment: _scrollAlignment, // Abhi
        scrollDirection: Axis.horizontal,
